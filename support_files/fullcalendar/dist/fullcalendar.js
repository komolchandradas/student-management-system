...
var FC = $.fullCalendar = {
	version: "3.5.1",
	// When introducing internal API incompatibilities (where fullcalendar plugins_file would break),
...
newMomentProto.time = function(time) {
	...
	// `time` is a generic enough method name where this precaution is necessary to avoid collisions w/ other plugins_file.
...
var CoordCache = FC.CoordCache = Class.extend({
	...
	// When called, if coord caches aren't built, Build them
