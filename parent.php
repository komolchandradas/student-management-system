 ...
 <div class="col-xs-4">
  ...
  <label style="width: 100px"><input type="radio" name="gender" value="Female" checked>Female</label>
                ...
                <div class="form-group">
                  ...
                  <input name="email" type="email" class="form-control" id="exampleInputPassword1" placeholder="Enter Parent Email" required>
                </div>
  ...
  <div class="form-group">
    ...
    <textarea name="address" class="form-control" id="exampleFormControlTextarea1" rows="2"></textarea>
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-info">Add Parent</button>
              </div>
            </form>
...
x.style.display='block';</script>";
  ...
  <label style="width: 100px"><input type="radio" name="gender" value="Female" <?php if($gender=='Female'){echo 'checked';} ?>>Female</label>
   ...
   <div class="form-group">
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-info">Update Parent</button>
              </div>
            </form>
