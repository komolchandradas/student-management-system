...
<!-- general form elements -->
 ...
 <div class="form-group">
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-info">Add Student</button>
              </div>
            </form>
...
<!-- general form elements -->
 ...
 <div class="form-group">
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-info">Update Student</button>
              </div>
            </form>
