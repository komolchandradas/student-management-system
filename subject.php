 ...
 <div class="col-xs-4">
    ...
    <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="10"></textarea>
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-info">Add Subject</button>
              </div>
            </form>
...
x.style.display='block';</script>";
 ...
 <div class="col-xs-4">
    ...
    <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="10"><?php echo $description; ?></textarea>
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-info">Update Subject</button>
              </div>
            </form>
