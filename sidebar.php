<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="stat"><a href="./"><i class="fa fa-pie-chart"></i> <span>Statistics</span> </a></li>

        <?php if($_SESSION['role']=='Teacher'){ ?>
        <li id="new"><a href="./student.php"><i class="fa fa-users"></i> <span>Student</span> </a></li>
        <li id="teacher"><a href="./teacher.php"><i class="fa fa-user-circle"></i> <span>Teacher</span> </a></li>
        <li id="parent"><a href="./parent.php"><i class="fa fa-user"></i> <span>Parents</span> </a></li>
        ...
        <li id="schedule"><a href="./schedule.php"><i class="fa fa-calendar"></i> <span>Schedule</span> </a></li>
        <li id="attendance"><a href="./attendance.php"><i class="fa fa-check-square"></i> <span>Attendance</span> </a></li>
        <li id="exam"><a href="./exam.php"><i class="fa fa-bar-chart"></i> <span>Exam</span> </a></li>
        ...
        <li id="notice"><a href="./notice.php"><i class="fa fa-envelope-open"></i> <span>Notice</span> </a></li>
      ...
      <li id="notice-role"><a href="./notice-role.php"><i class="fa fa-envelope-open"></i> <span>Notice</span> </a></li>
      <li id="examresults-stu"><a href="./examresults-stu.php"><i class="fa fa-graduation-cap"></i> <span>Exam Results</span> </a></li>   
      <li id="schedule-stu"><a href="./schedule-stu.php"><i class="fa fa-calendar"></i> <span>Schedule</span> </a></li>
