          ...
          <div class="box box-primary">
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name='date' class="form-control pull-right" id="datepicker" placeholder="Select Exam Date">
                </div>
                <!-- /.input group -->
           ...
           <div class="bootstrap-timepicker">
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="submit" class="btn btn-info">Add Exam</button>
              </div>
            </form>
